...
//         alert(client?._id ? "Client updated successfully!" : "Client added successfully!");
//         navigate("/clients");
//       } else {
//         console.error("Error:", data.message);
//         alert("Error: " + data.message);
...
import React, { useEffect, useState } from "react";
import { Card, Select, Input, Button, Form, Upload } from "antd";
import { useNavigate, useParams } from "react-router-dom";
import { ref, uploadBytes, getDownloadURL } from "firebase/storage";
        ...
        <Form form={form} layout="vertical" onFinish={handleSubmit}>
          ...
          {/* {client.jobPack && (
            <div style={{ marginTop: 15, display: "flex", gap: 15 }}>
              <a href={client.jobPack} target="_blank" rel="noopener noreferrer" style={viewLinkStyle}>🔍 View Job Pack</a>
              <a href={client.jobPack} download style={downloadLinkStyle}>📥 Download</a>
            </div>
          )} */}
          <div style={{ marginTop: "15px", display: "flex", gap: "15px", alignItems: "center" }}>
    <a
